...
Route::post('/',[PagesController::class,'fnRegistrar'])->name('Estudiantes.xRegistrar');

Route::get('/detalle/{id}',[PagesController::class, 'fnEstDetalle'])->name('Estudiantes.xDetalle');
